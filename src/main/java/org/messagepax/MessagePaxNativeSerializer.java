...
public class MessagePaxNativeSerializer extends BaseSerializer {
	 ...
	 *            Buffer to write to
	 */
	protected MessagePaxNativeSerializer(byte[] b) {
		super(b);
	}
	 ...
	 *             If object could not be serialized
	 */
	protected void writeStringLength(int len) throws IOException {
		if (len < 32) {
	 ...
	 *             If object could not be serialized
	 */
	protected void writeByteArrayLength(int len) throws IOException {
		if (len < 256) {
